...
const OAUTH_REFRESH_POLL_MS = 900 * 1e3;
const OAUTH_EXPIRES_SKEW_MS = 300 * 1e3;
//#endregion
...
var AntigravityAdapter = class extends LlmAdapter {
	...
	async *stream(options) {
		...
		try {
			...
			throw new LlmError(message, /\b401\b|\b403\b/.test(message) ? "AUTH" : /\b429\b/.test(message) ? "RATE_LIMIT" : /\b5\d\d\b/.test(message) ? "SERVER" : "TRANSPORT", { cause: error });
		}
	}
